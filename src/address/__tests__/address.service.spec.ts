...
describe('AuthService', () => {
  ...
  it('should return a address after save', async () => {
  ...
  it('should return a error if exception in userService', async () => {
  ...
  it('should return a error if exception in cityService', async () => {
